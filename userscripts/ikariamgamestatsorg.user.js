	...
	if (page != null) {
		if (page == 'townhall') {
			...
			if (GM_getValue('auto-islands_'+lang+'_'+server, '') && document.getElementById("gamestats-options-informations") == null) {
				sendRequest("th", location.href, getTownhall());
				displayInformation("&nbsp;");
			}
			...
			addEventListener('click', checkAction, false);
			if (GM_getValue('auto-islands_'+lang+'_'+server, '') && document.getElementById("gamestats-options-informations") == null) {
				sendRequest("bu", location.href, getBuildings());
				displayInformation("&nbsp;");
			}
		} else if (page == 'island') {
			...
			addEventListener('click', checkAction, false);
			if (GM_getValue('auto-islands_'+lang+'_'+server, '') && document.getElementById("gamestats-options-informations") == null) {
				sendRequest("tr", location.href, getTroops());
				displayInformation("&nbsp;");
			}
		} else if (page == 'fleet') {
			var box = createOptionsLayer('bottom', 160, 24, 0);
			...
			addEventListener('click', checkAction, false);
			if (GM_getValue('auto-islands_'+lang+'_'+server, '') && document.getElementById("gamestats-options-informations") == null) {
				sendRequest("fl", location.href, getFleet());
				displayInformation("&nbsp;");
			}
			...
			addEventListener('click', checkAction, false);
			if (GM_getValue('auto-islands_'+lang+'_'+server, '') && document.getElementById("gamestats-options-informations") == null) {
				sendRequest("er", location.href, getMainView());
				displayInformation("&nbsp;");
			}
		} else if (page == 'combat') {
			var box = createOptionsLayer('bottom', 160, 24, 0);
			...
			addEventListener('click', checkAction, false);
			if (GM_getValue('auto-islands_'+lang+'_'+server, '') && document.getElementById("gamestats-options-informations") == null) {
				sendRequest("cr", location.href, getMainView());
				displayInformation("&nbsp;");
			}
		} else if (page == 'stats') {
