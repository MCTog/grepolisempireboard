	...
	function renderTables()
	{
		...
		if (TABLE_BUILDINGS) 
		{
			...
			for (key in orderedBuildings) 
			{
					    ...
					    // s += "<th building='"+key+"' class='"+firstStyle+" build_name "+orderedBuildings[key]+" "+key+"' nowrap "+createTooltipAttribute(buildings[key][0])+">"+buildings[key][1]+"</th>";
						    ...
						    // s += "<th building='"+key+"' class='"+firstStyle+" build_name "+orderedBuildings[key]+" "+key+"' nowrap "+createTooltipAttribute("-")+">-</th>";
