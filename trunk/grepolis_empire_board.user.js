...
{uW=unsafeWindow;}else{uW=window;}
	...
	var default_style = <><![CDATA[
	                               ...
	                               GM_addStyle(default_style);
	                                ...
	                                EmpireBoard.Renders.Buildings_HeaderIcons = function(currentCityId)
	                                {
	                                	...
	                                	/*
	                                	 * rHTML +=
	                                	 * this.IconTo_researchAdvisor(); if
	                                	 * (reportViewToSurvey('researchAdvisor') ==
	                                	 * '!') { rHTML += '<sup class=Red
	                                	 * title="Require attention">!</sup>'; }
	                                	 * else { rHTML += '&nbsp;'; }
	                                	 */
	                                	return rHTML;
	                                };
	                                	...
	                                	else if (config["attacks"][townID] != undefined)
	                                	{
	                                		for (key in config["attacks"][townID])
	                                		{
	                                			...
	                                			if (arrivetime >= this._Parent.StartTime)
	                                			{
	                                				...
	                                				/*
	                                				 * if
	                                				 * ((this.DB.OwnCities[tCityId] !=
	                                				 * undefined) &&
	                                				 * (this.DB.OwnCities[tCityId].own !=
	                                				 * false)) { tCity =
	                                	...
	                                	var townId = Game.townId;
	                                		if (database[townId] == undefined)
	                                		{
	                                			...
	                                			$.ajax({
	                                				...
	                                				async: false,
	                                				dataType:"json",
	                                				url: "/game/town_group_overviews?action=get_towns_of_active_town_group&town_id="+townId,
	                                				error: function(){},
	                                				success: function(data){ 
	                                					$.each(data.towns,
	                                						function(nr) {
	                                					      ...
	                                					      EmpireBoard.Log.Add('Fetch select list: town ['+database[this.id].id+'], '+database[this.id].townName); 
	                                					    });
	                                				}
	                                			});
	                                			}
                            				...
                            				this._Parent.Log.Add('Fetch select list: this town ['+townId+'], '+database[townId].townName+', selected='+database[townId].selected);
...
//	                                		decimalPoint = '.' or ','
	                                		...
	                                		function realtimeSyncResources()
	                                		{
	                                			res['wood']=uW.Layout.resources['wood'];
	                                			res['stone']=uW.Layout.resources['stone'];
	                                			res['iron']=uW.Layout.resources['iron'];
...
//	                                		lots of code to get the town id. The code trys to find the town id no matter
	                                		...
	                                		function reportViewToSurvey(view, town_id)
	                                		{
	                                			...
	                                			else
	                                			{
	                                				...
	                                				else if (view == 'town')
	                                				{
	                                					...
	                                					/*
	                                					 * else if
	                                					 * ((town.underConstructionName !=
	                                					 * '') &&
	                                					 * (town.underConstructionTime <=
	                                					 * EmpireBoard.StartTime)) {
	                                					 * report = true; } else
	                                					 * if (town.towntime <=
	                                					 * (EmpireBoard.StartTime -
	                                					 * 1000*60*60*24*7)) {
	                                				...
	                                				else if ((view == 'townMilitary-fleet') || (view == 'building_docks'))
	                                				{
	                                					 ...
	                                					 * if ((view ==
	                                					 * 'townMilitary-fleet') &&
	                                					 * (town.townMilitaryfleetrqtime !=
	                                					 * undefined) &&
	                                					 * (town.townMilitaryfleetrqtime >
	                                					 * EmpireBoard.StartTime)) {
	                                					 * EmpireBoard.Log.Add("Will
	                                					 * request attention at
	                                					 * townMilitary-fleet of
	                                					 * town["+town_id+"]
	                                					 * remaining
...
//	                                		Current selected town
	                                		if (current_town_id > 0)
	                                		{
	                                			 ...
	                                			 * res.wood =
	                                			 * EmpireBoard.Grepolis.currentCity('wood','resources');
	                                			 * res.iron =
	                                			 * EmpireBoard.Grepolis.currentCity('iron','resources');
	                                			 * res.stone =
	                                			 * EmpireBoard.Grepolis.currentCity('stone','resources');
	                                			 * res.favor =
	                                			 * EmpireBoard.Grepolis.currentCity('crystal','resources');
	                                			 */
	                                			res.wood = uW.Layout.resources['wood'];
	                                			res.iron = uW.Layout.resources['iron'];
	                                			res.stone = uW.Layout.resources['stone'];
	                                		...
	                                		if (town_idmainView > 0)
	                                		{
	                                			...
	                                			if (EmpireBoard.Grepolis.View() == 'index')
	                                			{
	                                				...
	                                				for (name in gtb) {
	                                					if (gtb[name] != undefined)
	                                					{
	                                						...
	                                						res.buildings[name].data = gtb[name];
	                                						buildings[name] = [gtb[name].name, gtb[name].name];
	                                						EmpireBoard.Log.Add('index name='+name+", level="+gtb[name].level);
	                                					}
	                                					else
	                                					{
	                                						if (res.buildings[name] != undefined) {
	                                				...
	                                				if (EmpireBoard.Grepolis.View() == 'building_academy')
	                                				{
	                                					res.research["xx"]=1;
	                                					$(".academy_info is_researched:parent");
	                                				}
	                                					...
	                                					if (found == true)
	                                					{
	                                						...
	                                						if (enddate != 0 && currentdate != 0)
	                                						{
	                                							...
	                                							if (res.underConstructionName != '')
	                                							{
	                                								...
	                                								else if ((res.towntime != undefined) && (res.towntime > res.underConstructionTime))
	                                								{
	                                									// Ignore
	                                								}
	                                								else if ((res.buildings[res.underConstructionName].uptime != undefined) && (res.towntime != undefined))
	                                								{
	                                			...
	                                			if ((EmpireBoard.Grepolis.View() == "building_barracks") || (EmpireBoard.Grepolis.View() == "building_docks"))
	                                			{
	                                				 ...
	                                				 * res.units[currentUnit_id].construction =
	                                				 * 1; // Fetch queue var
	                                				 * simUnits = 0; var Amounts =
	                                				 * EmpireBoard.DOM.Get_Nodes("//div[@id='unitConstructionList']//li/div[@class='amount']");
	                                				 * if
	                                				 * (Amounts.snapshotLength >=
	                                				 * 1) { for (var i = 0; i <
	                                				 * Amounts.snapshotLength;
	                                				 * i++) { var Amount =
	                                				 * Amounts.snapshotItem(i);
	                                				 * var AmountInt =
	                                				 * EmpireBoard.Str.To_Integer(Amount.textContent,
	                                				 * 1); var unit_id = 'unit
	                                				 * '+EmpireBoard.Grepolis.Trim_Unit(Amount.parentNode.className);
	                                				 * 
	                                				 * res.units[unit_id].construction =
	                                				 * res.units[unit_id].construction +
	                                				 * AmountInt; if (unit_id ==
	                                				 * currentUnit_id) {
	                                				 * simUnits = simUnits +
	                                				 * AmountInt; } } }
	                                				 * 
	                                				 ...
	                                				 * for (var j =
	                                				 * scripts.length-1; j >= 0;
	                                				 * j--) { // search
	                                				 * getCountdown var nScript =
	                                				 * scripts[j]; var sCode =
	                                				 * nScript.innerHTML; if
	                                				 * (sCode.indexOf('buildProgress') >
	                                				 * 0) { found = true; break; } }
	                                				 * if (found == true) { var
	                                				 * enddate = 0; if
	                                				 * (/enddate[^0-9]*([0-9]+)/.exec(sCode) !=
	                                				 * null) { enddate =
	                                				 * parseFloat(RegExp.$1) *
	                                				 * 1000; } var currentdate =
	                                				 * 0; if
	                                				 * (/currentdate[^0-9]*([0-9]+)/.exec(sCode) !=
	                                				 * null) { currentdate =
	                                				 * parseFloat(RegExp.$1) *
	                                				 * 1000; } var startdate =
	                                				 * 0; if
	                                				 * (/startdate[^0-9]*([0-9]+)/.exec(sCode) !=
	                                				 * null) { startdate =
	                                				 * parseFloat(RegExp.$1) *
	                                				 * 1000; }
	                                				 * 
	                                				 * setViewRqTime(EmpireBoard.Grepolis.View(),
	                                				 * town_idmainView,
	                                				 * EmpireBoard.StartTime +
	                                				 * (enddate - currentdate) +
	                                				 * simUnits * (enddate -
	                                		...
	                                		function renderTables()
	                                		{
	                                			...
	                                			if (TABLE_BUILDINGS)
	                                			{
	                                				...
	                                				for (key in orderedBuildings)
	                                				{
	                                					...
	                                					if (buildings[key] != undefined) {
	                                						...
	                                						// class='"+firstStyle+"
	                                						// build_name
	                                						// "+orderedBuildings[key]+"
	                                						// "+key+"' nowrap
	                                						// "+createTooltipAttribute(buildings[key][0])+">"+buildings[key][1]+"</th>";
	                                			...
	                                			if (TABLE_RESOURCES) {
	                                				...
	                                				for (townId in Cities)
	                                				{
	                                					...
	                                					// EmpireBoard.Log.Add('population['+townId+']='+population);
	                                					...
	                                					// EmpireBoard.Log.Add('Storage volume of ' + townId + ': ' +maxcount+" ("+maxsafe+")");
	                                				...
	                                				if (usedIndexesCount > 0)
	                                				{
	                                					...
	                                					for(key in orderedUnits)
	                                					{
	                                						...
	                                						if (usedIndexes[key] == 1)
	                                						{
	                                							...
	                                							s += "<th unit='"+EmpireBoard.Grepolis.Trim_Unit(key)+"' class='"+firstStyle+" unit_name "+EmpireBoard.Grepolis.Trim_Unit(key)+"' nowrap "+createTooltipAttribute(name)+'style="background-image: url(&quot;http://static.grepolis.com/images/game/units/'+key+'_50x50.png&quot;);"></th>';
	                                							firstStyle = "";
	                                		...
	                                		if ((EmpireBoard.Grepolis.View() != '') && (EmpireBoard.Grepolis.View() != 'errorLoggedOut') && (EmpireBoard.Grepolis.View() != 'no-login-umod'))
	                                		{
	                                			...
	                                			script.src = "http://s6.de.ikariam.com/js/wz_tooltip.js";
